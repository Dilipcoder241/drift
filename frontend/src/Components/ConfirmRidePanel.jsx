  ...
  return (
    <div className='h-full overflow-y-scroll overflow-x-hidden'>
          <div>
            ...
            <h1 className='text-2xl font-semibold pt-4 px-4'>Confirm Your Ride</h1>
          </div>
          ...
          } className='text-center bg-[#438B52] text-white p-2 rounded-lg font-semibold text-lg w-full'>Cofirm</button>
          </div>
        </div>
  )
}
